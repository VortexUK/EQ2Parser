...
sources; the app itself is closed source). The latter two are on GitHub
(VortexUK/EQ2LexiconACTPlugin, EQAditu/AdvancedCombatTracker) — clone as
needed; only EQ2Lexicon is checked out locally.
